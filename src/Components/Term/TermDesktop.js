...
export default function TermDesktop(props) {
  const {
    defObs,
    defName,
    defReg,
    ...
    <div style={{ width: "768px" }}>
      <div className="Header">
        ...
        <p className="text-center DescLogo2">
          Termo de Responsabilidade Para Uso de Computador Desktop
        </p>
        <p className="text-center">
          Através da assinatura deste documento, declaro para os devidos fins
          que recebi o equipamento descrito abaixo, em perfeita condição de uso
          e de estado de conservação, e me comprometo a seguir as normas
      ...
      <div className="Body">
        ...
        <p className="Paragrafo text-justify">
          <b>2. </b>É de responsabilidade exclusiva do USUÁRIO a restituição do
          equipamento em caso de extravio, e/ou a reparação do mesmo por
          qualquer dano que este venha a sofrer, devendo o declarante arcar com
          todas as despesas de reparo, substituição e reposição, podendo ser
          descontado na folha de pagamento, conforme o artigo 462 § 1° da CLT;
        </p>
        <p className="Paragrafo text-justify">
          ...
          descumprimento desta norma poderá sofrer as sanções administrativas da
          empresa;
        </p>
        <p className="Paragrafo text-justify">
          <b>4. </b>O USUÁRIO tem somente a DETENÇÃO, tendo em vista o uso
          exclusivo para prestação de serviços profissionais e NÃO a PROPRIEDADE
          do equipamento, sendo terminantemente proibido o empréstimo, aluguel
          ou cessão deste a terceiros;
        </p>
        <p className="Paragrafo text-justify">
          <b>5. </b>Ao término da prestação de serviço ou do contrato individual
          de trabalho, o USUÁRIO compromete-se a devolver o equipamento em
          perfeito estado o mesmo dia em que for comunicado ou comunique seu
